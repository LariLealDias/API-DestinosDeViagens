...
namespace API_DestinosDeViagens.Migrations
{
    ...
    [Migration("20230821205157_FixingTheRelationshipBetweenRoadTripModelAndDestinationModel")]
    partial class FixingTheRelationshipBetweenRoadTripModelAndDestinationModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_DestinosDeViagens.Models.RoadTripModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("AverageAccommodationPrice")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<string>("AverageMealPrice")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("API_DestinosDeViagens.Models.RoadTripModel", b =>
                {
                    b.HasOne("API_DestinosDeViagens.Models.DestinationModel", "DestinationModel")
                        .WithOne("RoadTrip")
                        .HasForeignKey("API_DestinosDeViagens.Models.RoadTripModel", "DestinationModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DestinationModel");
                });
